  ...
  module Actions
    class UpdateChangeLogAction < Action
      def self.run(params)
          ...
          log_text = "## [#{log[:title]}](https://github.com/dengyhgit/FastActions/releases/tag/#{log[:version]}) (#{Time.now.strftime("%Y-%m-%d")})\n\n"
